...
select 
	CONVERT(UNIQUEIDENTIFIER, HASHBYTES('SHA1', N'vw_STAT_SUM_YEARS'+cast(man.ID as nvarchar(100))+CAST(year(cm.START_DATE) AS NVARCHAR(30)) + CAST(art.IS_ARTIST AS NVARCHAR(1)))) as __ID,
