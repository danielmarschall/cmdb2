...
const
  ...
  GUID_TEST_PLUGIN: TGUID = '{F20AF98B-9906-4BB5-9061-9D22FF5E4238}';
...
begin
  try
    ...
    try
      ...
      AdoConn.ExecSQL('insert into [STATISTICS] (ID, PLUGIN, NO, NAME) values ('''+GUID_9.ToString+''', ''Test'', ''100'', ''Menu Test'');');
